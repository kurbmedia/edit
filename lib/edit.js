(function() {
  ...
  Edit = (function(_super) {
    ...
    Edit.prototype.initialize = function() {
      ...
      this.$el.append($("<div id='editor_toolbar_content'></div>"));
      this._content = $('#editor_toolbar_content');
      instance = Edit.instance = this;
      return this;
    };

    Edit.prototype.append = function(content) {
      return this._content.append(content);
    };
    ...
    Edit.prototype.deactivate = function() {
      ...
      if (this.instance !== null) {
        ...
        this.instance.off('.edit').removeAttr('contenteditable').removeClass('editing multiline-editable');
        return this._content.tabs("destroy");
      }
    };
    ...
    Edit.prototype._addPanel = function(name, plugin) {
      ...
      this.append(plugin.render().el);
      return plugin.$el.attr('id', plugin_id).addClass('ui-helper-clearfix');
    };
    ...
    Edit.prototype._setOptions = function(passed) {
      ...
      return _.defaults(passed, this.defaults);
    };
